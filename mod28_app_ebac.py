...
def main():
    st.set_page_config(
        page_title="Módulo 19 | Streamlit II | Exercício 2",
        page_icon="https://raw.githubusercontent.com/pedropauloha/Exercicios-EBAC-Cientista-de-dados/main/img/ebac_logo-data_science.png",
        layout="wide",
    ...
    **Data da entrega:** 4 de maio de 2023.
    ...
    # SIDEBAR
    st.sidebar.image(image="https://raw.githubusercontent.com/pedropauloha/Exercicios-EBAC-Cientista-de-dados/main/img/Bank-Branding.jpg")
   

    st.sidebar.write("## Suba o arquivo")
    data_file_1 = st.sidebar.file_uploader(
        label="Carregue os dados aqui", type=["csv", "xlsx"]
    )
